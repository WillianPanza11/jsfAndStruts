...
<html>
    ...
    <body>
        ...
        <s:form>
            <s:textfield key="form.nombre"  name="persona.nombre"></s:textfield>
            <s:textfield key="form.calle"  name="persona.domicilio.calle"></s:textfield>
            <s:textfield key="form.no.calle"  name="persona.domicilio.numeroCalle"></s:textfield>
            <s:textfield key="form.pais" name="persona.domicilio.pais"></s:textfield>
