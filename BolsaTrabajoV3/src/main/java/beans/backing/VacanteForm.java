...
public class VacanteForm extends Object {
    ...
    @Inject
    private ColoniaHelper coloniaHepler;
    ...
    public void codigoPostalListener(ValueChangeEvent valueChangeEvent) {
        ...
        int coloniaId = this.coloniaHepler.getColoniaidPorCP(nuevoCodigoPostal);
        coloniaIdInputText.setValue(coloniaId);
        coloniaIdInputText.setSubmittedValue(coloniaId);

        UIInput ciudadInputText = (UIInput) uiViewRoot.findComponent("vacanteForm:ciudad");
        String nuevaCiudad = "Ciudad de Cuenca";
    ...
    public ColoniaHelper getColoniaHepler() {
        return coloniaHepler;
    }

    public void setColoniaHepler(ColoniaHelper coloniaHepler) {
        this.coloniaHepler = coloniaHepler;
    }
